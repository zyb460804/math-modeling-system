...
- 运行 `quality-assurance-auditor/scripts/check_result_reasonableness.py` 验证结果合理性（参考 `quality-assurance-auditor/references/result-validation-rules.md` 规则集，v4.8 整合自 result-validator）
```
